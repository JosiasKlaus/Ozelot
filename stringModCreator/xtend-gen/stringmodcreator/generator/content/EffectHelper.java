...
public class EffectHelper {
  public static String getPotionEffectString(final PotionEffects potionEffect) {
  ...
  public static String getEffectInstaceString(final Effect effect, final String target) {
    ...
    String _potionEffectString = EffectHelper.getPotionEffectString(effect.getPotionEffects());
    _builder.append(_potionEffectString);
    _builder.append(") || player.getEffect(");
    String _potionEffectString_1 = EffectHelper.getPotionEffectString(effect.getPotionEffects());
    _builder.append(_potionEffectString_1);
    _builder.append(").getAmplifier() < (level*factor - 1)){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append(target, "\t");
    _builder.append(".addEffect(new MobEffectInstance(");
    String _potionEffectString_2 = EffectHelper.getPotionEffectString(effect.getPotionEffects());
    _builder.append(_potionEffectString_2, "\t");
    _builder.append(", ");
    int _duration = effect.getDuration();
    int _multiply = (_duration * 20);
    ...
    String _potionEffectString_3 = EffectHelper.getPotionEffectString(effect.getPotionEffects());
    _builder.append(_potionEffectString_3, "\t");
    _builder.append(").update(new MobEffectInstance(");
    String _potionEffectString_4 = EffectHelper.getPotionEffectString(effect.getPotionEffects());
    _builder.append(_potionEffectString_4, "\t");
    _builder.append(", ");
    int _duration_1 = effect.getDuration();
    int _multiply_1 = (_duration_1 * 20);
