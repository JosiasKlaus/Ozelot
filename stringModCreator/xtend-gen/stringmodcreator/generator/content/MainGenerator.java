...
public class MainGenerator {
  public static void run(final Mod mod) {
    ...
    String _plus_3 = (_plus_2 + "/src/resources\"");
    ...
    String _plus_5 = (_baseFolder_1 + "/src/resources/META-INF");
    ...
    FileGenerator.generateFile(
      "mods.toml", _plus_5, _builder_2.toString(), 
      true);
