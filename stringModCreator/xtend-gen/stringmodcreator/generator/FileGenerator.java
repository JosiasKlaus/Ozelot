...
public class FileGenerator {
  ...
  public static void generateJavaClass(final String className, final String packageExtension, final String extensions, final String imports, final String content, final Mod mod, final boolean isMain) {
  ...
  public static void generateJavaClass(final String className, final String packageExtension, final String extensions, final String imports, final String content, final Mod mod) {
    FileGenerator.generateJavaClass(className, packageExtension, extensions, imports, content, mod, false);
  }
}
