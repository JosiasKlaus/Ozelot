...
public class Main {
  ...
  public static Mod getData() {
    ...
    Item _item = new Item(null, "C:/Users/johfr/Desktop/my_item.png", true, 64, false, "my_1_item", _newArrayList, 
      Rarity.COMMON, 
      CreativeModeTab.MISC, _newArrayList_1, _newArrayList_2);
    ...
    ArrayList<Translation> _newArrayList_3 = CollectionLiterals.<Translation>newArrayList(_translation_1, _translation_2);
    ...
    ArrayList<OnTickEffect> _newArrayList_4 = CollectionLiterals.<OnTickEffect>newArrayList(_onTickEffect, _onTickEffect_1);
    ArrayList<SelfOtherEffect> _newArrayList_5 = CollectionLiterals.<SelfOtherEffect>newArrayList();
    ArrayList<Effect> _newArrayList_6 = CollectionLiterals.<Effect>newArrayList();
    ...
    ArrayList<Effect> _newArrayList_7 = CollectionLiterals.<Effect>newArrayList(_effect, _effect_1);
    FoodItem _foodItem = new FoodItem(null, "C:/Users/johfr/Desktop/my_item.png", false, 16, true, "my_2_item", _newArrayList_3, 
      Rarity.COMMON, 
      CreativeModeTab.MISC, _newArrayList_4, _newArrayList_5, _newArrayList_6, 
      10, 
      0.3f, 
      false, 
      true, _newArrayList_7);
    ArrayList<Item> _newArrayList_8 = CollectionLiterals.<Item>newArrayList(_item, _foodItem);
    Block _block = new Block();
    Block _block_1 = new Block();
    Block _block_2 = new Block();
    ArrayList<Block> _newArrayList_9 = CollectionLiterals.<Block>newArrayList(_block, _block_1, _block_2);
    return new Mod("examplemod", "My Test Mod", "this is my test mod", "Author", "C:/Users/johfr/Desktop/my_mod.png", "0.0.1", _newArrayList_8, _newArrayList_9);
  }
}
