...
public class EffectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Effect_level_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Effect_level_feature", "_UI_Effect_type"),
						OzelotPackage.Literals.EFFECT__LEVEL, true, false, false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Effect_duration_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Effect_duration_feature",
								"_UI_Effect_type"),
						OzelotPackage.Literals.EFFECT__DURATION, true, false, false,
	...
	protected void addVisiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Effect_visible_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Effect_visible_feature",
								"_UI_Effect_type"),
						OzelotPackage.Literals.EFFECT__VISIBLE, true, false, false,
