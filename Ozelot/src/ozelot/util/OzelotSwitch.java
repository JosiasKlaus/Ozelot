 ...
 * @generated
 */
public class OzelotSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OzelotPackage.SELF_OTHER_EFFECT: {
				SelfOtherEffect selfOtherEffect = (SelfOtherEffect)theEObject;
				T result = caseSelfOtherEffect(selfOtherEffect);
				if (result == null) result = caseEffect(selfOtherEffect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OzelotPackage.ON_TICK_EFFECT: {
				OnTickEffect onTickEffect = (OnTickEffect)theEObject;
				T result = caseOnTickEffect(onTickEffect);
				if (result == null) result = caseEffect(onTickEffect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Self Other Effect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Self Other Effect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelfOtherEffect(SelfOtherEffect object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>On Tick Effect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>On Tick Effect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
