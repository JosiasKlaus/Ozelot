...
public class TranslationImpl extends MinimalEObjectImpl.Container implements Translation {
	...
	protected EClass eStaticClass() {
		return OzelotPackage.Literals.TRANSLATION;
	}
	...
	public void setLang(String newLang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.TRANSLATION__LANG, oldLang, lang));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.TRANSLATION__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.TRANSLATION__DESCRIPTION, oldDescription, description));
	}
