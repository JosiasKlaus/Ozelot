...
public class FoodItemImpl extends ItemImpl implements FoodItem {
	...
	public void setNutrition(int newNutrition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.FOOD_ITEM__NUTRITION, oldNutrition, nutrition));
	}
	...
	public void setSaturation(float newSaturation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.FOOD_ITEM__SATURATION, oldSaturation, saturation));
	}
	...
	public void setIsAlwaysEdible(boolean newIsAlwaysEdible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.FOOD_ITEM__IS_ALWAYS_EDIBLE, oldIsAlwaysEdible, isAlwaysEdible));
	}
