...
public class ItemImpl extends MinimalEObjectImpl.Container implements Item {
		...
		if (toolProperty != null && toolProperty.eIsProxy()) {
			...
			if (toolProperty != oldToolProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OzelotPackage.ITEM__TOOL_PROPERTY, oldToolProperty, toolProperty));
			}
		}
		return toolProperty;
	}
	...
	public void setToolProperty(ToolProperty newToolProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.ITEM__TOOL_PROPERTY, oldToolProperty, toolProperty));
	}
	...
	public void setIconPath(String newIconPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.ITEM__ICON_PATH, oldIconPath, iconPath));
	}
	...
	public void setMaxStackSize(int newMaxStackSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.ITEM__MAX_STACK_SIZE, oldMaxStackSize, maxStackSize));
	}
	...
	public void setIsImmuneToFire(boolean newIsImmuneToFire) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OzelotPackage.ITEM__IS_IMMUNE_TO_FIRE, oldIsImmuneToFire, isImmuneToFire));
	}
