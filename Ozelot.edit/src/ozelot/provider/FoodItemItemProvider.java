		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FoodItem_nutrition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FoodItem_nutrition_feature", "_UI_FoodItem_type"),
				 OzelotPackage.Literals.FOOD_ITEM__NUTRITION,
				 true,
				 false,
				 false,
	...
	protected void addSaturationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FoodItem_saturation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FoodItem_saturation_feature", "_UI_FoodItem_type"),
				 OzelotPackage.Literals.FOOD_ITEM__SATURATION,
				 true,
				 false,
				 false,
	...
	protected void addIsMeatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FoodItem_isMeat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FoodItem_isMeat_feature", "_UI_FoodItem_type"),
				 OzelotPackage.Literals.FOOD_ITEM__IS_MEAT,
				 true,
				 false,
				 false,
	...
	protected void addIsAlwaysEdiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FoodItem_isAlwaysEdible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FoodItem_isAlwaysEdible_feature", "_UI_FoodItem_type"),
				 OzelotPackage.Literals.FOOD_ITEM__IS_ALWAYS_EDIBLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
