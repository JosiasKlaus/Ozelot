...
public class ModItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mod_items_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mod_items_feature", "_UI_Mod_type"),
	...
	protected void addBlocksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mod_blocks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mod_blocks_feature", "_UI_Mod_type"),
	...
	public String getText(Object object) {
		String label = ((Mod)object).getModId();
