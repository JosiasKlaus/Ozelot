	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OzelotPackage.Literals.MOD__ITEMS,
				 OzelotFactory.eINSTANCE.createItem()));

		newChildDescriptors.add
			(createChildParameter
				(OzelotPackage.Literals.MOD__ITEMS,
				 OzelotFactory.eINSTANCE.createFoodItem()));

		newChildDescriptors.add
			(createChildParameter
				(OzelotPackage.Literals.MOD__BLOCKS,
				 OzelotFactory.eINSTANCE.createBlock()));
	}
